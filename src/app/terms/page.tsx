    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-slate max-w-none">
          <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">1. 定义</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
            <strong>&ldquo;履程&rdquo;</strong>指由履程团队运营的能力展示与成长记录平台，包括网站、移动应用及相关服务。
          </p>
          <p className="text-slate-600 leading-relaxed mb-4">
            <strong>&ldquo;用户&rdquo;</strong>指注册并使用履程平台服务的个人或企业。
          </p>
          <p className="text-slate-600 leading-relaxed mb-4">
            <strong>&ldquo;企业用户&rdquo;</strong>指以企业身份注册、发布挑战赛或使用人才搜索服务的用户。
          </p>
          ...
          <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">3. 账号注册与使用</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">4. 用户内容</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">5. 能力评估说明</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">6. 企业挑战赛</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">7. 禁止行为</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
            使用本平台时，禁止以下行为：
          </p>
          ...
          <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">8. 服务变更与终止</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
            我们可能会不时更新或调整平台功能。对于重大变更，我们会提前通知用户。
            如因不可抗力等原因导致服务中断，平台不承担责任。
          </p>

          <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">9. 免责声明</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
            平台按&ldquo;现状&rdquo;提供服务，不对服务的适用性、可靠性做出明示或暗示的保证。
            在法律允许的最大范围内，平台不对任何间接、附带、特殊损失承担责任。
          </p>

          <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">10. 条款修改</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
            我们可能会不时修改本服务条款。修改后的条款会在平台上公布，
            继续使用平台即表示您同意修改后的条款。
          </p>

          <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">11. 联系我们</h2>
