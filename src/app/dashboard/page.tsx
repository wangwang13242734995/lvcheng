      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="space-y-4">
          <div className="bg-white p-6 rounded-xl">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center p-3 bg-gray-50 rounded-lg">
                <p className="text-2xl font-bold text-indigo-600">{data?.projects?.length || 0}</p>
                <p className="text-sm text-gray-500">项目总数</p>
              </div>
              <div className="text-center p-3 bg-gray-50 rounded-lg">
                <p className="text-2xl font-bold text-green-600">{data?.growthRecords?.length || 0}</p>
          ...
          <div className="bg-indigo-50 p-6 rounded-xl">
            <h2 className="text-lg font-semibold mb-2 text-indigo-900">💡 AI 建议</h2>
